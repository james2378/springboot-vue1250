...
import qiugouxinxiList from '../pages/qiugouxinxi/list'
import qiugouxinxiDetail from '../pages/qiugouxinxi/detail'
import qiugouxinxiAdd from '../pages/qiugouxinxi/add'
      ...
      redirect: '/index/home'
    },
		{
			...
			children:[
				...
				{
					path: 'qiugouxinxi',
					component: qiugouxinxiList
				},
				{
					path: 'qiugouxinxiDetail',
					component: qiugouxinxiDetail
				},
				{
					path: 'qiugouxinxiAdd',
					component: qiugouxinxiAdd
				},
				{
					path: 'juanzengxinxi',
