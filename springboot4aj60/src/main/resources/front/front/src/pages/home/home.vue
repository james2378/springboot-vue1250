...
<div class="recommend" :style='{"width":"100%","padding":"20px 0 30px","margin":"0","position":"relative","background":"url(http://codegen.caihongy.cn/20230127/cb48feb1ff1b497faa783e042fab17b3.jpg) repeat-y center top / 100% 100%"}'>
    ...
    <div class="title" :style='{"minHeight":"50px","padding":"0 0 30px","margin":"60px auto 40px","alignItems":"center","background":"url(http://codegen.caihongy.cn/20230127/08c16dc8bbc641d9b10f2c8403aeb7f1.png) no-repeat center bottom","display":"flex","width":"100%","justifyContent":"center"}'>
		<span :style='{"color":"#fff","fontSize":"30px","lineHeight":"50px"}'>商品信息推荐</span>
	</div>
	...
	<div class="list list2 index-pv1" :style='{"padding":"0 7%","margin":"20px 0 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
		<div :style='{"margin":"0 0 30px","flexWrap":"wrap","background":"#fff","display":"flex","width":"23.5%","fontSize":"0","position":"relative","justifyContent":"space-between","height":"auto"}' v-for="(item,index) in shangpinxinxiRecommend" class="list-item animation-box" :key="index" @click="toDetail('shangpinxinxiDetail', item)">
			<img :style='{"border":"none","padding":"10px 10px 60px","objectFit":"cover","background":"url(http://codegen.caihongy.cn/20230127/ef04f1f0d78145d4b55871efdc1e6549.png) no-repeat center bottom / 100% auto,#7dd8ee","display":"inline-block","width":"100%","height":"380px"}' v-if="preHttp(item.tupian)" :src="item.tupian.split(',')[0]" alt="" />
			<img :style='{"border":"none","padding":"10px 10px 60px","objectFit":"cover","background":"url(http://codegen.caihongy.cn/20230127/ef04f1f0d78145d4b55871efdc1e6549.png) no-repeat center bottom / 100% auto,#7dd8ee","display":"inline-block","width":"100%","height":"380px"}' v-else :src="baseUrl + (item.tupian?item.tupian.split(',')[0]:'')" alt="" />
			<div class="item-info" :style='{"width":"100%","padding":"10px 0","verticalAlign":"middle","overflow":"hidden","display":"inline-block","height":"100%"}'>
				<div class="name line1" :style='{"margin":"0 0 10px","whiteSpace":"nowrap","overflow":"hidden","color":"#333","textAlign":"center","width":"100%","lineHeight":"40px","fontSize":"16px","textOverflow":"ellipsis","fontWeight":"500","height":"40px"}'>商品名称:{{item.shangpinmingcheng}}</div>
				<div class="name line1" :style='{"margin":"0 0 10px","whiteSpace":"nowrap","overflow":"hidden","color":"#333","textAlign":"center","width":"100%","lineHeight":"40px","fontSize":"16px","textOverflow":"ellipsis","fontWeight":"500","height":"40px"}'>商品分类:{{item.shangpinfenlei}}</div>
				<div class="name line1" :style='{"margin":"0 0 10px","whiteSpace":"nowrap","overflow":"hidden","color":"#333","textAlign":"center","width":"100%","lineHeight":"40px","fontSize":"16px","textOverflow":"ellipsis","fontWeight":"500","height":"40px"}'>规格:{{item.guige}}</div>
			</div>
		</div>
	</div>
	...
	<div @click="moreBtn('shangpinxinxi')" :style='{"padding":"0 20px","margin":"10px auto","textAlign":"center","background":"none","display":"inline-block","width":"100%","lineHeight":"40px"}'>
...
<div class="lists" :style='{"width":"100%","padding":"30px 7%","margin":"0 auto","position":"relative","background":"url(http://codegen.caihongy.cn/20230127/3dc7a96395244ef894fde9c1deda72e9.jpg) no-repeat center bottom,linear-gradient(180deg, rgba(209,238,254,1) 0%, rgba(252,253,254,1) 40%, rgba(252,253,254,1) 100%),#fcfdfe","display":"block"}'>
	...
	<div class="title" :style='{"margin":"0 auto 20px","alignItems":"center","background":"url(http://codegen.caihongy.cn/20230127/9b960911d44148759e8047661d17347b.png) no-repeat center bottom","display":"flex","width":"100%","lineHeight":"50px","justifyContent":"center"}'>
	  <span :style='{"padding":"0 0 30px","fontSize":"32px","lineHeight":"50px","color":"#111"}'>求购信息展示</span>
	</div>
	...
	<div class="list list5 index-pv1">
		<div id="lists-five-swiperqiugouxinxi" class="swiper-container lists-five-swiper" :style='{"width":"100%","padding":"50px 10px","margin":"40px 0 0","background":"none"}'>
			<div class="swiper-wrapper">
				<div :style='{"border":"0","padding":"20px","fontSize":"0","position":"relative","borderRadius":"4px","background":"none"}' class="swiper-slide" v-for="(item,index) in qiugouxinxiList" :key="index" @click="toDetail('qiugouxinxiDetail', item)">
					<img :style='{"border":"0","width":"200px","padding":"40px 20px","background":"url(http://codegen.caihongy.cn/20230128/d927f93371f746899f81fd3ae78502d1.png) no-repeat center top / 100% 100%","height":"220px"}' v-if="preHttp(item.tupian)" :src="item.tupian.split(',')[0]" alt="" />
					<img :style='{"border":"0","width":"200px","padding":"40px 20px","background":"url(http://codegen.caihongy.cn/20230128/d927f93371f746899f81fd3ae78502d1.png) no-repeat center top / 100% 100%","height":"220px"}' v-else :src="baseUrl + (item.tupian?item.tupian.split(',')[0]:'')" alt="" />
				</div>
			</div>
			<!-- Add Arrows -->
	...
	<div @click="moreBtn('qiugouxinxi')" :style='{"border":"0","padding":"0 20px","margin":"40px auto 50px","textAlign":"center","background":"none","display":"inline-block","width":"100%","lineHeight":"40px"}'>
		<span :style='{"color":"#3e97c6","fontSize":"18px"}'>查看更多</span>
		<i v-if="true" :style='{"color":"#3e97c6","fontSize":"18px"}' class="el-icon-d-arrow-right"></i>
	</div>
...
<div class="lists" :style='{"width":"100%","padding":"30px 7%","margin":"0 auto","position":"relative","background":"url(http://codegen.caihongy.cn/20230127/3dc7a96395244ef894fde9c1deda72e9.jpg) no-repeat center bottom,linear-gradient(180deg, rgba(209,238,254,1) 0%, rgba(252,253,254,1) 40%, rgba(252,253,254,1) 100%),#fcfdfe","display":"block"}'>
	...
	<div class="title" :style='{"margin":"0 auto 20px","alignItems":"center","background":"url(http://codegen.caihongy.cn/20230127/9b960911d44148759e8047661d17347b.png) no-repeat center bottom","display":"flex","width":"100%","lineHeight":"50px","justifyContent":"center"}'>
	  <span :style='{"padding":"0 0 30px","fontSize":"32px","lineHeight":"50px","color":"#111"}'>捐赠信息展示</span>
	</div>
	...
	<!-- 样式五 -->
	<div class="list list5 index-pv1">
		<div id="lists-five-swiperjuanzengxinxi" class="swiper-container lists-five-swiper" :style='{"width":"100%","padding":"50px 10px","margin":"40px 0 0","background":"none"}'>
			<div class="swiper-wrapper">
				<div :style='{"border":"0","padding":"20px","fontSize":"0","position":"relative","borderRadius":"4px","background":"none"}' class="swiper-slide" v-for="(item,index) in juanzengxinxiList" :key="index" @click="toDetail('juanzengxinxiDetail', item)">
					<img :style='{"border":"0","width":"200px","padding":"40px 20px","background":"url(http://codegen.caihongy.cn/20230128/d927f93371f746899f81fd3ae78502d1.png) no-repeat center top / 100% 100%","height":"220px"}' v-if="preHttp(item.tupian)" :src="item.tupian.split(',')[0]" alt="" />
					<img :style='{"border":"0","width":"200px","padding":"40px 20px","background":"url(http://codegen.caihongy.cn/20230128/d927f93371f746899f81fd3ae78502d1.png) no-repeat center top / 100% 100%","height":"220px"}' v-else :src="baseUrl + (item.tupian?item.tupian.split(',')[0]:'')" alt="" />
				</div>
			</div>
	...
	<div @click="moreBtn('juanzengxinxi')" :style='{"border":"0","padding":"0 20px","margin":"40px auto 50px","textAlign":"center","background":"none","display":"inline-block","width":"100%","lineHeight":"40px"}'>
		<span :style='{"color":"#3e97c6","fontSize":"18px"}'>查看更多</span>
		<i v-if="true" :style='{"color":"#3e97c6","fontSize":"18px"}' class="el-icon-d-arrow-right"></i>
	</div>
      ...
      getSystemIntroduction() {
		...
		getList() {
          ...
          autoSortUrl = "shangpinxinxi/autoSort";
			...
			this.$http.get('qiugouxinxi/list', {params: {
				page: 1,
				limit: 8,
			}}).then(res => {
				if (res.data.code == 0) {
					this.qiugouxinxiList = res.data.data.list;
					
					// 商品列表样式五
					this.$nextTick(() => {
						new Swiper('#lists-five-swiperqiugouxinxi', {
							loop: true,
							speed: 500,
			...
			this.$http.get('juanzengxinxi/list', {params: {
				page: 1,
				limit: 8,
			}}).then(res => {
				if (res.data.code == 0) {
					this.juanzengxinxiList = res.data.data.list;
					
					// 商品列表样式五
					this.$nextTick(() => {
						new Swiper('#lists-five-swiperjuanzengxinxi', {
							loop: true,
							speed: 500,
							slidesPerView: Number(5),
							spaceBetween: Number(10),
